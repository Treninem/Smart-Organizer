...
class WindowsPathTests(unittest.TestCase):
    def test_redirected_desktop_is_respected(self):
        with mock.patch("core.windows_paths._known_folder_from_shell", return_value=Path(r"D:\\Рабочий стол")):
            self.assertEqual(desktop_path(), Path(r"D:\\Рабочий стол"))

    def test_redirected_downloads_are_respected(self):
        with mock.patch("core.windows_paths._known_folder_from_shell", return_value=Path(r"D:\\Загрузки")):
